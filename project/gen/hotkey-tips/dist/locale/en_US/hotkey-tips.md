...
| `Alt + Shift + f` | Launch File Manager (lingmo-filemanager) |
| `Alt + Shift + g` | Launch File Manager (pcmanfm-qt) |
| `Alt + Shift + e` | Launch Text Editor (lingmo-texteditor) |
| `Alt + Shift + b` | Launch Web Browser (firefox) |
| `Alt + Shift + s` | Launch System Setting (lingmo-settings) |
| `Alt + Enter` | Launch Terminal (lingmo-terminal) |
| `Alt + Shift + a` | Launch Terminal (lingmo-terminal) |
| `Alt + Ctrl + a` | Launch Terminal (sakura) |
| `Alt + Shift + t` | Launch Terminal (lingmo-terminal) |
