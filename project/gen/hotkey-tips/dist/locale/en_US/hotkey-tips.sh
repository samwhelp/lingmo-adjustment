...
"Alt + Shift + f" "Launch File Manager (lingmo-filemanager)" "#cccccc" "Monospace 16" \
"Alt + Shift + g" "Launch File Manager (pcmanfm-qt)" "#ffffff" "Monospace 16" \
"Alt + Shift + e" "Launch Text Editor (lingmo-texteditor)" "#cccccc" "Monospace 16" \
"Alt + Shift + b" "Launch Web Browser (firefox)" "#ffffff" "Monospace 16" \
"Alt + Shift + s" "Launch System Setting (lingmo-settings)" "#cccccc" "Monospace 16" \
"Alt + Enter" "Launch Terminal (lingmo-terminal)" "#ffffff" "Monospace 16" \
"Alt + Shift + a" "Launch Terminal (lingmo-terminal)" "#cccccc" "Monospace 16" \
"Alt + Ctrl + a" "Launch Terminal (sakura)" "#ffffff" "Monospace 16" \
"Alt + Shift + t" "Launch Terminal (lingmo-terminal)" "#cccccc" "Monospace 16" \
