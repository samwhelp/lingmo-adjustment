...
base_var_init () {
	...
	THE_MASTER_ASSET_CONFIG_DIR_NAME="config"
	THE_MASTER_ASSET_CONFIG_DIR_PATH="${THE_MASTER_ASSET_DIR_PATH}/${THE_MASTER_ASSET_CONFIG_DIR_NAME}"
...
base_var_dump () {
	...
	util_debug_echo "THE_MASTER_ASSET_CONFIG_DIR_NAME=${THE_MASTER_ASSET_CONFIG_DIR_NAME}"
	util_debug_echo "THE_MASTER_ASSET_CONFIG_DIR_PATH=${THE_MASTER_ASSET_CONFIG_DIR_PATH}"
	util_debug_echo
